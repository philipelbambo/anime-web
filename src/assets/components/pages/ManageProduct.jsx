...
// Mock BreadcrumbSearch component since it's imported
const BreadcrumbSearch = () => (
  <nav className="mb-4">
    <ol className="flex space-x-2 text-sm text-gray-600">
      <li><a href="/Dashboard" className="hover:text-blue-600">Dashboard</a></li>
      <li>/</li>
      <li><a href="/manageproduct" className="hover:text-blue-600">Manage Product</a></li>
    </ol>
  </nav>
);
...
const ManageProduct = () => {
  ...
  return (
    <div className="min-h-screen w-full" style={{ backgroundColor: '#e0e0e0' }}>
